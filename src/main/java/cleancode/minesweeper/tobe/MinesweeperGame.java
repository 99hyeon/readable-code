...
public class MinesweeperGame {
    ...
    public static final int LAND_NINE_COUNT = 10;
    ...
    private static int getSelectedRowIndex(String cellInput) {
        ...
        return selectedRowFrom(cellInputRow);
    }

    private static int getSelectedColIndex(String cellInput) {
        char cellInputCol = cellInput.charAt(0);
        return selectedColFrom(cellInputCol);
    }
    ...
    private static int selectedRowFrom(char cellInputRow) {
        return Character.getNumericValue(cellInputRow) - 1;
    }

    private static int selectedColFrom(char cellInputCol) {
        switch (cellInputCol) {
            case 'a':
                return 0;
            case 'b':
    ...
    private static void initializeGame() {
        ...
        for (int i = 0; i < LAND_NINE_COUNT; i++) {
